...
public class Solution {
    ...
    */
    ...
    public boolean isSuccessful(GameModel model){
        ...
        Solution copy = new Solution(model.getWidth(), model.getHeight());
        
        for(int i = 0; i < ((width*height)-1); i++){
            if(model.isON(i/width, i%height) == true){
                copy.setNext(true);
            }
            else{
                copy.setNext(false);
    ...
    */
    ...
    public boolean stillPossible(boolean nextValue, GameModel model) {
        ...
        for(int i = 0; i < ((width*height)-1); i++){
            if(model.isON(i/width, i%width) == true){
                copy.setNext(true);
            }
            else{
                copy.setNext(false);
        ...
        return copy.stillPossible(nextValue);
    }
